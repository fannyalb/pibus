#############################################################################
# Makefile for building: pibus
# Generated by qmake (3.1) (Qt 5.13.2)
# Project:  pibus.pro
# Template: app
# Command: /usr/lib64/qt5/bin/qmake -o Makefile pibus.pro
#############################################################################
...
Makefile: pibus.pro .qmake.cache /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
...
qrc_qml.cpp: resources/qml.qrc \
		...
		resources/NavigationView.qml \
		resources/MusicView.qml \
		resources/Dashboard.qml \
		resources/RadioView.qml \
		resources/DashboardButton.qml \
		resources/Geocode.qml \
		resources/Marker.qml \
		resources/RadioButton.qml \
		resources/AddressForm.qml \
		resources/main.qml \
		resources/images/volume_down.svg \
		resources/images/pause.svg \
		resources/images/volume_off.svg \
		resources/images/stop.svg \
		resources/images/play.svg \
		resources/images/playlist_add.svg \
		resources/images/replay.svg \
		resources/images/marker.png \
		resources/images/next.svg \
		resources/images/search.svg \
		resources/images/volume_up.svg \
		resources/images/previous.svg \
		resources/images/shuffle.svg
	/usr/lib64/qt5/bin/rcc -name qml resources/qml.qrc -o qrc_qml.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/pibus/bin || mkdir -p $(INSTALL_ROOT)/opt/pibus/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/pibus/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/pibus/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/pibus/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/pibus/bin/ 
