...
# Project:  pibus.pro
# Template: app
# Command: /usr/lib64/qt5/bin/qmake -o Makefile pibus.pro -spec linux-g++
#############################################################################
...
Makefile: pibus.pro .qmake.cache /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		pibus.pro \
		src/qml.qrc
	$(QMAKE) -o Makefile pibus.pro -spec linux-g++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/dashboard.h src/musicplayer.h $(DISTDIR)/
	$(COPY_FILE) --parents src/dashboard.cpp src/musicplayer.cpp src/pibus.cpp $(DISTDIR)/
...
qrc_qml.cpp: src/qml.qrc \
		...
		src/AddressForm.qml \
		src/main.qml \
		src/images/volume_down.svg \
		src/images/pause.svg \
		src/images/volume_off.svg \
		src/images/stop.svg \
		src/images/play.svg \
		src/images/playlist_add.svg \
...
compiler_moc_header_make_all: moc_dashboard.cpp moc_musicplayer.cpp
