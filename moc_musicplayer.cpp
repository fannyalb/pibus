...
QT_MOC_LITERAL(1, 12, 15), // "songNameChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 8) // "songName"

    },
    "MusicPlayer\0songNameChanged\0\0songName"
};
...
void MusicPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MusicPlayer::songNameChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MusicPlayer::songNameChanged()
{
